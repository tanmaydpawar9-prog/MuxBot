...
- [ ] 3. Update `core/downloader.py` - Increase throttle to 4s, add try/except in progress
- [ ] 4. Update `utils/ffmpeg.py` - Add ffmpeg existence check, better error handling
- [ ] 5. Update `main.py` - Add logging around key operations
